...
from ..defense.byzantine_robust_aggregation import multi_krum, bulyan, tr_mean, median
from ..defense.flame import flame
from ..defense.sparsefed import sparsefed
from ..defense.epfed import epfed

from ..attack.fang import fang_trmean_gray, fang_trmean_white

import optuna

def backdoor_attack_fedavg_tune(args, trial):
    ...
    associated_loss = 1000000000000000000000
    ...
    for t in range(args.round):
        ...
        for i in selected_idxs:
            ...
            if attack_flag and attack_cnt < args.num_attackers:
                if args.attack == 'dba':
            ...
            if defend_flag and args.defend == 'epfed':
                pass
            else:
        ...
        if args.attack == 'fang_tr_mean' or args.attack == 'fang_median':
        ...
        #     exit()
    return associated_loss, best_test_accuracy