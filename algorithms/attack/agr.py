...
MIN-MAX attack
'''
def agrAgnosticMinMax(all_updates, args, model_re=None, dev_type='std', threshold=10):
...
def agrAgnosticMinSum(all_updates, args, model_re=None, dev_type='std', threshold=10):
...
def agrTailoredTrmean(all_updates, args, dev_type='std', threshold=10):
